package com.api.hub.vector.util;
...
public class WeaviateEmbeddingStore {
    ...
    List<String> addAll(List<Embedding> embeddings, List<TextSegment> embedded) {
    ...
    public EmbeddingSearchResult<TextSegment> search(EmbeddingSearchRequest request, String persona) {
        ...
        WhereFilter personaFilter = WhereFilter.builder()
        	    .path("persona")
